...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.SurveyUI = {}, global.Survey));
    ...
    ***************************************************************************** */
    ...
    var SurveyAction = /** @class */ (function (_super) {
        ...
        SurveyAction.prototype.renderElement = function () {
            ...
            var separator = this.item.needSeparator ? (_$1(SurveyActionBarSeparator, null)) : null;
    ...
    var SurveyActionBarItem = /** @class */ (function (_super) {
        ...
        SurveyActionBarItem.prototype.renderElement = function () {
            return _$1(k$2, null, this.renderInnerButton());
        };
        ...
        SurveyActionBarItem.prototype.renderButtonContent = function () {
            ...
            var svgIcon = !!this.item.iconName ? (_$1(SvgIcon, { className: this.item.cssClasses.itemIcon, size: this.item.iconSize, iconName: this.item.iconName, title: this.item.tooltip || this.item.title })) : null;
            return (_$1(k$2, null,
                svgIcon,
                text));
        };
        SurveyActionBarItem.prototype.renderInnerButton = function () {
            ...
            var button = attachKey2click(_$1("button", { className: className, type: "button", disabled: this.item.disabled, onMouseDown: function (args) { return _this.item.doMouseDown(args); }, onFocus: function (args) { return _this.item.doFocus(args); }, onClick: function (args) { return _this.item.doAction(args); }, title: title, tabIndex: tabIndex, "aria-checked": this.item.ariaChecked, "aria-expanded": this.item.ariaExpanded, "aria-labelledby": this.item.ariaLabelledBy, role: this.item.ariaRole }, buttonContent), this.item, { processEsc: false });
            return button;
        };
    ...
    var PopupContainer = /** @class */ (function (_super) {
        ...
        PopupContainer.prototype.renderHeaderPopup = function (popupModel) {
            var _this = this;
            return popupModel.showCloseButton ? _$1("button", { tabIndex: -1, className: "sv-popup__close-button sd-action sd-action--icon", onClick: function () { return _this.model.clickClose(); } },
        ...
        PopupContainer.prototype.render = function () {
            ...
            return (_$1("div", { tabIndex: -1, className: className, style: style, onClick: function (e) {
    ...
    var TitleActions = /** @class */ (function (_super) {
        ...
        TitleActions.prototype.render = function () {
            var titleContent = _$1(TitleContent, { element: this.element, cssClasses: this.cssClasses });
    ...
    var TitleElement = /** @class */ (function (_super) {
        ...
        TitleElement.prototype.render = function () {
            ...
            var titleContent = (_$1(TitleActions, { element: element, cssClasses: element.cssClasses, renderActions: this.props.renderActions }));
    ...
    var ComponentsContainer = /** @class */ (function (_super) {
        ...
        ComponentsContainer.prototype.render = function () {
            ...
            if (!needRenderWrapper) {
                return _$1(k$2, null, components.map(function (component) {
            ...
            return _$1("div", { className: "sv-components-column" + " sv-components-container-" + this.props.container }, components.map(function (component) {
                return ReactElementFactory.Instance.createElement(component.component, { survey: _this.props.survey, model: component.data, container: _this.props.container, key: component.id });
            }));
        };
    ...
    var PopupModal = /** @class */ (function (_super) {
        ...
        PopupModal.prototype.renderElement = function () {
            return _$1(k$2, null, this.modalManager.getModals().map(function (model) { return $(_$1(PopupContainer, { model: model }), model.container, model.uniqueId.toString()); }));
        };
    ...
    var Scroll = /** @class */ (function (_super) {
        ...
        Scroll.prototype.render = function () {
            ...
            return this.props.disabled ?
                _$1(k$2, null, this.props.children) :
                _$1("div", { ref: this.rootRef, className: "sv-scroll__wrapper" },
                    _$1("div", { className: "sv-scroll__scroller sv-drag-target-skipped", onScroll: function () { return _this.model.onScrollContainer(); } },
                        _$1("div", { className: "sv-scroll__container" }, this.props.children)),
                    _$1("div", { className: "sv-scroll__scrollbar", onScroll: function () { return _this.model.onScrollScrollbar(); } },
    ...
    surveyCore.addIconsToThemeSet("v1", iconsV1Exports.icons);
    surveyCore.addIconsToThemeSet("v2", iconsV2Exports.icons);
    surveyCore.SvgRegistry.registerIcons(iconsV2Exports.icons);
    var Survey = /** @class */ (function (_super) {
        ...
        Survey.prototype.doRender = function () {
            ...
            var backgroundImage = !!this.survey.backgroundImage ? _$1("div", { className: this.css.rootBackgroundImage, style: this.survey.backgroundImageStyle }) : null;
            var header = this.survey.headerView === "basic" ? _$1(SurveyHeader, { survey: this.survey }) : null;
            var onSubmit = function (event) {
                event.preventDefault();
            };
            var customHeader = _$1("div", { className: "sv_custom_header" });
    ...
    var SurveyTimerPanel = /** @class */ (function (_super) {
        ...
        SurveyTimerPanel.prototype.render = function () {
            ...
            var result = _$1("div", { className: this.timerModel.survey.getCss().timerRoot }, this.timerModel.text);
            if (this.timerModel.showTimerAsClock) {
                var style = { strokeDasharray: this.circleLength, strokeDashoffset: this.progress };
                var progress = (this.timerModel.showProgress ? _$1(SvgIcon, { className: this.timerModel.getProgressCss(), style: style, iconName: "icon-timercircle", size: "auto" }) : null);
                result =
    ...
    var SurveyRow = /** @class */ (function (_super) {
        ...
        SurveyRow.prototype.renderElementContent = function () {
            ...
            var elements = this.row.visibleElements.map(function (element, elementIndex) {
                return (_$1(SurveyRowElement, { element: element, index: elementIndex, row: _this.row, survey: _this.survey, creator: _this.creator, css: _this.css, key: element.id }));
            });
    ...
    var SurveyElementHeader = /** @class */ (function (_super) {
        ...
        SurveyElementHeader.prototype.renderElement = function () {
            var element = this.element;
            var title = element.hasTitle ? (_$1(TitleElement, { element: element })) : null;
            var description = element.hasDescriptionUnderTitle
                ? SurveyElementBase.renderQuestionDescription(this.element)
                : null;
            var additionalTitleToolbarElement = element.hasAdditionalTitleToolbar ? _$1(SurveyActionBar, { model: element.additionalTitleToolbar }) : null;
            var headerStyle = { width: undefined };
            if (element instanceof surveyCore.Question) {
                headerStyle.width = element.titleWidth;
            }
            return (_$1("div", { className: element.cssHeader, onClick: function (e) { return element.clickTitleFunction && element.clickTitleFunction(e.nativeEvent); }, style: headerStyle },
                title,
                description,
    ...
    var SurveyQuestionSigleInputSummary = /** @class */ (function (_super) {
        ...
        SurveyQuestionSigleInputSummary.prototype.renderItems = function () {
            var _this = this;
            return (_$1("div", { className: this.css.summary }, this.summary.items.map(function (item, index) { return _this.renderItem(item, index); })));
        };
        ...
        SurveyQuestionSigleInputSummary.prototype.renderItem = function (item, index) {
            var btnEdit = item.btnEdit ?
                _$1("button", { className: this.css.summaryRowActionEdit, onClick: function () { return item.btnEdit.action(); }, title: item.btnEdit.title },
                    _$1(SvgIcon, { iconName: "icon-editsmall-16x16", iconSize: "auto" })) : null;
            var btnDelete = item.showRemove && item.btnRemove ?
                _$1("button", { className: this.css.summaryRowActionDelete, onClick: function () { return item.btnRemove.action(); }, title: item.btnRemove.title },
    ...
    var SurveyBreadcrumbs = /** @class */ (function (_super) {
        ...
        SurveyBreadcrumbs.prototype.renderItems = function () {
            ...
            this.items.concat([]).forEach(function (item, itemIndex) {
                if (itemIndex) {
                    result.push(_$1(SvgIcon, { key: item.renderedId + "_separator", className: _this.css.breadcrumbsSeparator, iconName: "arrowright-16x16", size: "auto" }));
                }
    ...
    var SurveyQuestionAndErrorsWrapped = /** @class */ (function (_super) {
        ...
        SurveyQuestionAndErrorsWrapped.prototype.renderContent = function () {
            ...
            return (_$1(k$2, null, renderedQuestion));
        };
    ...
    var SurveyPage = /** @class */ (function (_super) {
        ...
        SurveyPage.prototype.renderElement = function () {
            ...
            var errors = (_$1(SurveyElementErrors, { element: this.panelBase, cssClasses: this.panelBase.cssClasses, creator: this.creator }));
    ...
    var SurveyFlowPanel = /** @class */ (function (_super) {
        ...
        SurveyFlowPanel.prototype.renderNode = function (node) {
            ...
            if (nodeType === "question") {
                ...
                if (!question)
                    return null;
                var questionBody = (_$1(SurveyQuestion, { key: question.name, element: question, creator: this.creator, css: this.css }));
    ...
    var SurveyQuestionSelectbase = /** @class */ (function (_super) {
        ...
        SurveyQuestionSelectbase.prototype.renderElement = function () {
            ...
            return (_$1("fieldset", { className: this.question.getSelectBaseRootCss(), ref: function (fieldset) { return (_this.setControl(fieldset)); }, role: this.question.a11y_input_ariaRole, "aria-required": this.question.a11y_input_ariaRequired, "aria-label": this.question.a11y_input_ariaLabel, "aria-labelledby": this.question.a11y_input_ariaLabelledBy, "aria-describedby": this.question.a11y_input_ariaDescribedBy, "aria-invalid": this.question.a11y_input_ariaInvalid, "aria-errormessage": this.question.a11y_input_ariaErrormessage },
                this.renderHeader(),
        ...
        SurveyQuestionSelectbase.prototype.getColumns = function (cssClasses) {
            ...
            return this.question.columns.map(function (column, ci) {
                ...
                return (_$1("div", { key: "column" + ci + _this.question.getItemsColumnKey(column), className: _this.question.getColumnClass(), role: "presentation" }, items));
            });
        };
    ...
    var SurveyQuestionCheckboxItem = /** @class */ (function (_super) {
        ...
        SurveyQuestionCheckboxItem.prototype.renderCheckbox = function (isChecked) {
            ...
            var itemLabel = !this.hideCaption ? _$1("span", { className: this.cssClasses.controlLabel }, this.renderLocString(this.item.locText, this.textStyle)) : null;
    ...
    var SurveyQuestionRanking = /** @class */ (function (_super) {
        ...
        SurveyQuestionRanking.prototype.renderElement = function () {
            ...
            if (!this.question.selectToRankEnabled) {
                return (_$1("div", { className: this.question.rootClass, ref: function (root) { return (_this.setControl(root)); } }, this.getItems()));
            }
            else {
                var unrankedItem = true;
                return (_$1("div", { className: this.question.rootClass, ref: function (root) { return (_this.setControl(root)); } },
    ...
    var RatingItemStar = /** @class */ (function (_super) {
        ...
        RatingItemStar.prototype.render = function () {
            var _this = this;
            return (_$1("label", { className: this.item.className, onMouseDown: this.handleOnMouseDown, onMouseOver: function (e) { return _this.question.onItemMouseIn(_this.item); }, onMouseOut: function (e) { return _this.question.onItemMouseOut(_this.item); }, title: this.item.text },
                _$1("input", { type: "radio", className: "sv-visuallyhidden", name: this.question.questionName, id: this.question.getInputId(this.index), value: this.item.value, disabled: this.question.isDisabledAttr, readOnly: this.question.isReadOnlyAttr, checked: this.question.value == this.item.value, onClick: this.props.handleOnClick, onChange: function () { }, "aria-label": this.question.ariaLabel }),
    ...
    var RatingItemSmiley = /** @class */ (function (_super) {
        ...
        RatingItemSmiley.prototype.render = function () {
            var _this = this;
            return (_$1("label", { style: this.item.style, className: this.item.className, onMouseDown: this.handleOnMouseDown, onMouseOver: function (e) { return _this.question.onItemMouseIn(_this.item); }, onMouseOut: function (e) { return _this.question.onItemMouseOut(_this.item); }, title: this.item.text },
                _$1("input", { type: "radio", className: "sv-visuallyhidden", name: this.question.questionName, id: this.question.getInputId(this.index), value: this.item.value, disabled: this.question.isDisabledAttr, readOnly: this.question.isReadOnlyAttr, checked: this.question.value == this.item.value, onClick: this.props.handleOnClick, onChange: function () { }, "aria-label": this.question.ariaLabel }),
    ...
    var SurveyQuestionTagbox = /** @class */ (function (_super) {
        ...
        SurveyQuestionTagbox.prototype.renderItem = function (key, item) {
            var renderedItem = (_$1(SurveyQuestionTagboxItem, { key: key, question: this.question, item: item }));
            return renderedItem;
        };
        ...
        SurveyQuestionDropdownSelect.prototype.renderSelect = function (cssClasses) {
            ...
            _$1("div", { id: this.question.inputId, className: this.question.getControlClass(), disabled: true }, this.question.readOnlyText)) :
                (_$1("select", { id: this.question.inputId, className: this.question.getControlClass(), ref: function (select) { return (_this.setControl(select)); }, autoComplete: this.question.autocomplete, onChange: this.updateValueOnEvent, onInput: this.updateValueOnEvent, onClick: click, onKeyUp: keyup, "aria-required": this.question.a11y_input_ariaRequired, "aria-label": this.question.a11y_input_ariaLabel, "aria-invalid": this.question.a11y_input_ariaInvalid, "aria-errormessage": this.question.a11y_input_ariaErrormessage, required: this.question.isRequired },
                    ...
                    this.question.visibleChoices.map(function (item) { return _$1(SurveyQuestionOptionItem, { key: item.uniqueId, item: item }); })));
        ...
        SurveyQuestionMatrix.prototype.renderElement = function () {
            ...
            var header = !this.question.showHeader ? null : (_$1("thead", { role: "presentation" },
                _$1("tr", null,
                    rowsTH,
                    headers)));
            return (_$1("div", { className: this.question.getTableWrapperCss(), ref: function (root) { return (_this.setControl(root)); } },
        ...
        SurveyQuestionMatrixRow.prototype.generateTds = function () {
            ...
            var _loop_1 = function () {
                ...
                if (this_1.question.hasCellText) {
                    ...
                    td = (_$1("td", { key: key, className: itemClass, onClick: getHandler ? getHandler(column) : function () { } }, this_1.renderLocString(this_1.question.getCellDisplayLocText(row.name, column))));
                }
                else {
                    ...
                    td = (_$1("td", { key: key, "data-responsive-title": column.locText.renderedHtml, className: this_1.question.cssClasses.cell }, renderedCell));
                }
                tds.push(td);
            };
            var this_1 = this;
    ...
    var SurveyQuestionFile = /** @class */ (function (_super) {
        ...
        SurveyQuestionFile.prototype.renderElement = function () {
            ...
            var fileNavigator = this.question.fileNavigatorVisible ? (_$1(SurveyActionBar, { model: this.question.fileNavigator })) : null;
            ...
            if (this.question.isReadOnlyAttr) {
                fileInput = _$1("input", { readOnly: true, type: "file", className: className, id: this.question.inputId, ref: function (input) { return (_this.setControl(input)); }, style: style, multiple: this.question.allowMultiple, placeholder: this.question.title, accept: acceptedTypes });
            }
            else if (this.question.isDisabledAttr) {
                fileInput = _$1("input", { disabled: true, type: "file", className: className, id: this.question.inputId, ref: function (input) { return (_this.setControl(input)); }, style: style, multiple: this.question.allowMultiple, placeholder: this.question.title, accept: acceptedTypes });
            }
            ...
            return (_$1("div", { className: this.question.fileRootCss, ref: function (el) { return (_this.setContent(el)); } },
                fileInput,
        ...
        SurveyQuestionFile.prototype.renderFileDecorator = function () {
            var actionsContainer = this.question.actionsContainerVisible ? _$1(SurveyActionBar, { model: this.question.actionsContainer }) : null;
    ...
    var SurveyFileChooseButton = /** @class */ (function (_super) {
        ...
        SurveyFileChooseButton.prototype.render = function () {
            var _this = this;
            return attachKey2click(_$1("label", { tabIndex: 0, className: this.question.getChooseFileCss(), htmlFor: this.question.inputId, "aria-label": this.question.chooseButtonText, onClick: function (e) { return _this.question.chooseFile(e.nativeEvent); } },
    ...
    var SurveyFilePreview = /** @class */ (function (_super) {
        ...
        SurveyFilePreview.prototype.renderFileSign = function (className, val) {
            ...
            if (!className || !val.name)
                return null;
            return (_$1("div", { className: className },
                _$1("a", { href: val.content, onClick: function (event) {
        ...
        SurveyFilePreview.prototype.renderElement = function () {
            var _this = this;
            var content = this.question.renderedPages.map(function (page, index) { return (_$1(SurveyFilePage, { page: page, question: _this.question, key: page.id })); });
    ...
    var SurveyFileItem = /** @class */ (function (_super) {
        ...
        SurveyFileItem.prototype.renderElement = function () {
            var _this = this;
            var val = this.item;
            return (_$1("span", { className: this.question.cssClasses.previewItem, onClick: function (event) { return _this.question.doDownloadFileFromContainer(event); } },
                ...
                _$1("div", { className: this.question.getImageWrapperCss(val) },
                    ...
                    val.name && !this.question.isReadOnly ? (_$1("div", { className: this.question.getRemoveButtonCss(), onClick: function (event) { return _this.question.doRemoveFile(val, event); } },
    ...
    var SurveyQuestionRadiogroup = /** @class */ (function (_super) {
        ...
        SurveyQuestionRadiogroup.prototype.renderClearButton = function () {
            ...
            if (!this.question.showClearButtonInContent)
                return null;
            return (_$1("div", null,
                _$1("input", { type: "button", className: this.question.cssClasses.clearButton, onClick: function () { return _this.question.clearValueFromUI(); }, value: this.question.clearButtonCaption })));
        };
    ...
    var SurveyQuestionRadioItem = /** @class */ (function (_super) {
        ...
        SurveyQuestionRadioItem.prototype.renderRadioButton = function () {
            ...
            var itemLabel = !this.hideCaption ? _$1("span", { className: controlLabelClass }, this.renderLocString(this.item.locText, this.textStyle)) : null;
            return (_$1("div", { className: itemClass, role: "presentation", ref: this.rootRef },
    ...
    var SurveyQuestionText = /** @class */ (function (_super) {
        ...
        SurveyQuestionText.prototype.renderInput = function () {
            ...
            var counter = !!this.question.getMaxLength() ? (_$1(CharacterCounterComponent, { counter: this.question.characterCounter, remainingCharacterCounter: this.question.cssClasses.remainingCharacterCounter })) : null;
            return (_$1(k$2, null,
        ...
        SurveyQuestionBoolean.prototype.renderElement = function () {
            ...
            return (_$1("div", { className: cssClasses.root, onKeyDown: this.handleOnKeyDown },
                _$1("label", { className: itemClass },
                    ...
                    _$1("div", { className: cssClasses.sliderGhost, onClick: function (event) { return _this.handleOnLabelClick(event, _this.question.swapOrder); } },
    ...
    var SurveyQuestionMatrixDynamicDragDropIcon = /** @class */ (function (_super) {
        ...
        SurveyQuestionMatrixDynamicDragDropIcon.prototype.renderElement = function () {
            var _this = this;
            return _$1("div", { onPointerDown: function (event) { _this.question.onPointerDown(event.nativeEvent, _this.row); } }, this.renderIcon());
        };
    ...
    var SurveyQuestionMatrixTable = /** @class */ (function (_super) {
        ...
        SurveyQuestionMatrixTable.prototype.renderRow = function (keyValue, row, cssClasses, reason) {
            ...
            return (_$1(k$2, { key: key }, (reason == "row-footer") ? _$1("tr", null, matrixrow) : _$1(MatrixRow, { model: row, parentMatrix: this.question }, matrixrow)));
        };
        ...
        SurveyQuestionMatrixTable.prototype.renderCellContent = function (cell, reason, cssClasses) {
            ...
            if (cell.hasTitle) {
                ...
                var require_1 = !!cell.column ? _$1(SurveyQuestionMatrixHeaderRequired, { column: cell.column, question: this.question }) : null;
                cellContent = (_$1(k$2, null,
                    str,
                    require_1));
            }
            ...
            if (!cellContent)
                return null;
            var readyCell = (_$1(k$2, null, cellContent));
    ...
    var SurveyQuestionMatrixDropdownBase = /** @class */ (function (_super) {
        ...
        SurveyQuestionMatrixDropdownBase.prototype.renderTableDiv = function () {
            var _this = this;
            return (_$1("div", { className: this.question.getTableWrapperCss(), ref: function (root) { return (_this.setControl(root)); } },
                _$1(SurveyQuestionMatrixTable, { question: this.question, creator: this.creator, wrapCell: function (cell, element, reason) { return _this.wrapCell(cell, element, reason); } })));
        };
    ...
    var SurveyQuestionMatrixDropdownErrorsCell = /** @class */ (function (_super) {
        ...
        SurveyQuestionMatrixDropdownErrorsCell.prototype.render = function () {
            if (!this.cell.isVisible)
                return null;
            return _$1("td", { className: this.cell.className, key: this.key, colSpan: this.cell.colSpans, title: this.cell.getTitle() }, _super.prototype.render.call(this));
        };
    ...
    var SurveyQuestionMatrixDropdownCell = /** @class */ (function (_super) {
        ...
        SurveyQuestionMatrixDropdownCell.prototype.renderCellContent = function () {
            ...
            var responsiveTitle = this.cell.showResponsiveTitle ? (_$1("span", { className: this.cell.responsiveTitleCss },
    ...
    var SurveyQuestionMatrixDynamicAddButton = /** @class */ (function (_super) {
        ...
        SurveyQuestionMatrixDynamicAddButton.prototype.renderElement = function () {
            ...
            var addButton = (_$1("button", { className: this.matrix.getAddRowButtonCss(this.props.isEmptySection), type: "button", disabled: this.matrix.isInputReadOnly, onClick: this.matrix.isDesignMode ? undefined : this.handleOnRowAddClick },
                addRowText,
    ...
    var SurveyQuestionMatrixDynamicPlaceholder = /** @class */ (function (_super) {
        ...
        SurveyQuestionMatrixDynamicPlaceholder.prototype.renderElement = function () {
            ...
            var textDiv = _$1("div", { className: cssClasses.noRowsText }, text);
    ...
    ReactElementFactory.Instance.registerElement("sv-matrixdynamic-add-btn", function (props) { return _$1(SurveyQuestionMatrixDynamicAddButton, props); });
    ReactElementFactory.Instance.registerElement("sv-placeholder-matrixdynamic", function (props) { return _$1(SurveyQuestionMatrixDynamicPlaceholder, props); });
    ...
    var SurveyQuestionPanelDynamic = /** @class */ (function (_super) {
        ...
        SurveyQuestionPanelDynamic.prototype.renderElement = function () {
            ...
            this.question.renderedPanels.forEach(function (panel, index) {
                panels.push(_$1(SurveyQuestionPanelDynamicItem, { key: panel.id, element: panel, question: _this.question, index: index, cssClasses: cssClasses, isDisplayMode: _this.isDisplayMode, creator: _this.creator }));
            });
    ...
    ReactElementFactory.Instance.registerElement("sv-placeholder-paneldynamic", function (props) { return _$1(SurveyQuestionPanelDynamicPlaceholder, props); });
    ...
    var SurveyProgressButtons = /** @class */ (function (_super) {
        ...
        SurveyProgressButtons.prototype.render = function () {
            var _a;
            var _this = this;
            return (_$1("div", { className: this.model.getRootCss(this.props.container), style: (_a = { "maxWidth": this.model.progressWidth }, _a["--sd-progress-buttons-pages-count"] = this.model.visiblePages.length, _a), role: "progressbar", "aria-valuemin": 0, "aria-valuemax": 100, "aria-label": this.model.progressBarAriaLabel },
                ...
                _$1("div", { className: this.css.progressButtonsContainer },
                    _$1("div", { className: this.model.getScrollButtonCss(this.state.hasScroller, true), role: "button", onClick: function () {
                    ...
                    _$1("div", { className: this.model.getScrollButtonCss(this.state.hasScroller, false), role: "button", onClick: function () {
        ...
        SurveyProgressButtons.prototype.renderListElement = function (page, index) {
            ...
            return (_$1("li", { key: "listelement" + index, className: this.model.getListElementCss(index), onClick: this.model.isListElementClickable(index)
                ...
                this.state.canShowItemTitles ? _$1(k$2, null,
    ...
    var ListItem = /** @class */ (function (_super) {
        ...
        ListItem.prototype.render = function () {
            ...
            var contentWrap = _$1("div", { ref: this.elementRef, style: this.model.getItemStyle(this.item), className: this.model.cssClasses.itemBody, title: this.item.getTooltip(), onMouseOver: function (event) { _this.model.onItemHover(_this.item); }, onMouseLeave: function (event) { _this.model.onItemLeave(_this.item); } }, newElement);
            var separator = this.item.needSeparator ? _$1("div", { className: this.model.cssClasses.itemSeparator }) : null;
            var isVisible = this.model.isItemVisible(this.item);
            var style = {
                display: isVisible ? null : "none"
            };
            return attachKey2click(_$1("li", { className: className, role: this.model.listItemRole, style: style, id: this.item.elementId, "aria-selected": this.model.getA11yItemAriaSelected(this.item), "aria-checked": this.model.getA11yItemAriaChecked(this.item), onClick: function (event) {
    ...
    var List = /** @class */ (function (_super) {
        ...
        List.prototype.renderList = function () {
            ...
            return (_$1("ul", { className: this.model.getListClass(), style: ulStyle, role: this.model.listRole, "aria-label": this.model.a11ya11y_input_ariaLabel, id: this.model.elementId, onMouseDown: function (e) {
                    e.preventDefault();
        ...
        List.prototype.renderItems = function () {
            ...
            return items.map(function (item, itemIndex) {
                return (_$1(ListItem, { model: _this.model, item: item, key: "item" + itemIndex }));
            });
        };
        List.prototype.searchElementContent = function () {
            ...
            if (!this.model.showFilter)
                ...
                var clearButton = this.model.showSearchClearButton && !!this.model.filterString ?
                    _$1("button", { className: this.model.cssClasses.searchClearButtonIcon, onClick: function (event) { _this.model.onClickSearchClearButton(event); } },
    ...
    var SurveyQuestionRating = /** @class */ (function (_super) {
        ...
        SurveyQuestionRating.prototype.renderElement = function () {
            ...
            var maxText = this.question.maxRateDescription
                ...
                : null;
            return (_$1("div", { className: this.question.ratingRootCss, ref: function (div) { return (_this.setControl(div)); } },
    ...
    var SurveyQuestionSlider = /** @class */ (function (_super) {
        ...
        SurveyQuestionSlider.prototype.renderElement = function () {
            ...
            return (_$1("div", { className: this.question.rootCss, ref: function (div) { return (_this.setControl(div)); } },
                rangeInput,
                _$1("div", { className: cssClasses.visualContainer, onPointerUp: function (e) { setValueByClickOnPath(e.nativeEvent, _this.control); } },
        ...
        SurveyQuestionSlider.prototype.getInputsAndThumbs = function () {
            ...
            for (var i = 0; i < value.length; i++) {
                var thumbAndInput = _$1(k$2, { key: i },
                    this.getInput(i),
                    this.getThumb(i));
        ...
        SurveyQuestionSlider.prototype.getThumb = function (i) {
            ...
            var thumb = _$1("div", { className: getThumbContainerCss(i), style: { left: getPercent(value) + "%" } },
                tooltip,
    ...
    var SurveyQuestionExpression = /** @class */ (function (_super) {
        ...
        SurveyQuestionExpression.prototype.renderElement = function () {
            var _this = this;
            var cssClasses = this.question.cssClasses;
            return (_$1("div", { id: this.question.inputId, className: cssClasses.root, ref: function (div) { return (_this.setControl(div)); }, "aria-live": "polite", "aria-label": this.question.formatedValue }, this.question.formatedValue));
        };
    ...
    var PopupSurvey = /** @class */ (function (_super) {
        ...
        PopupSurvey.prototype.renderElement = function () {
            ...
            return (_$1("div", { className: this.popup.cssRoot, style: style, onScroll: function () { return _this.popup.onScroll(); } },
        ...
        PopupSurvey.prototype.renderCloseButton = function (popup) {
            var _this = this;
            return (_$1("div", { className: popup.cssHeaderCloseButton, onClick: function () {
                    popup.hide();
        ...
        PopupSurvey.prototype.renderAllowFullScreenButon = function (popup) {
            ...
            return (_$1("div", { className: popup.cssHeaderFullScreenButton, onClick: function () { popup.toggleFullScreen(); } }, Icon));
        };
    ...
    var SurveyQuestionImagePicker = /** @class */ (function (_super) {
        ...
        SurveyQuestionImagePicker.prototype.renderItem = function (item, cssClasses) {
            var renderedItem = _$1(SurveyQuestionImagePickerItem, { key: item.uniqueId, question: this.question, item: item, cssClasses: cssClasses });
            var survey = this.question.survey;
            var wrappedItem = null;
            if (!!survey) {
                wrappedItem = ReactSurveyElementsWrapper.wrapItemValue(survey, renderedItem, this.question, item);
    ...
    var SurveyQuestionImagePickerItem = /** @class */ (function (_super) {
        ...
        SurveyQuestionImagePickerItem.prototype.renderElement = function () {
            ...
            if (item.locImageLink.renderedHtml && this.question.contentMode === "video") {
                control = (_$1("video", { controls: true, className: cssClasses.image, src: item.locImageLink.renderedHtml, width: this.question.renderedImageWidth, height: this.question.renderedImageHeight, style: style, onLoadedMetadata: function (event) { _this.question["onContentLoaded"](item, event.nativeEvent); }, onError: function (event) { item.onErrorHandler(item, event.nativeEvent); } }));
            }
            if (!item.locImageLink.renderedHtml || item.contentNotLoaded) {
                ...
                control = (_$1("div", { className: cssClasses.itemNoImage, style: style_1 }, cssClasses.itemNoImageSvgIcon ?
                    _$1(SvgIcon, { className: cssClasses.itemNoImageSvgIcon, iconName: this.question.cssClasses.itemNoImageSvgIconId, size: 48 }) :
                    null));
            }
            var renderedItem = (_$1("div", { className: itemClass },
    ...
    var SurveyQuestionImageMap = /** @class */ (function (_super) {
        ...
        SurveyQuestionImageMap.prototype.renderElement = function () {
            var _this = this;
            return (_$1("div", { className: this.question.cssClasses.root, ref: function (root) { return (_this.setControl(root)); } },
                _$1("img", { className: this.question.cssClasses.bg, id: "".concat(this.question.id, "-bg"), src: this.question.imageLink, role: "presentation" }),
                _$1("svg", { className: this.question.cssClasses.svg, id: "".concat(this.question.id, "-svg") })));
        };
    ...
    var SurveyQuestionImage = /** @class */ (function (_super) {
        ...
        SurveyQuestionImage.prototype.renderElement = function () {
            ...
            if (this.question.renderedMode === "image") {
                control = (_$1("img", { className: cssClasses, src: this.question.locImageLink.renderedHtml || null, alt: this.question.renderedAltText, width: this.question.renderedWidth, height: this.question.renderedHeight, style: style, onLoad: function (event) { _this.question.onLoadHandler(); }, onError: function (event) { _this.question.onErrorHandler(); } }));
            }
            if (this.question.renderedMode === "video") {
                control = (_$1("video", { controls: true, className: cssClasses, src: this.question.locImageLink.renderedHtml, width: this.question.renderedWidth, height: this.question.renderedHeight, style: style, onLoadedMetadata: function (event) { _this.question.onLoadHandler(); }, onError: function (event) { _this.question.onErrorHandler(); } }));
            }
    ...
    var SurveyQuestionSignaturePad = /** @class */ (function (_super) {
        ...
        SurveyQuestionSignaturePad.prototype.renderElement = function () {
            ...
            return (_$1("div", { className: cssClasses.root, ref: function (root) { return (_this.setControl(root)); }, style: { width: this.question.renderedCanvasWidth } },
                ...
                _$1("div", null,
                    ...
                    _$1("canvas", { tabIndex: -1, className: this.question.cssClasses.canvas, onBlur: function (event) { _this.question.onBlur(event); } })),
                clearButton,
                loadingIndicator));
        };
        ...
        SurveyQuestionSignaturePad.prototype.renderCleanButton = function () {
            ...
            return _$1("div", { className: cssClasses.controls },
                _$1("button", { type: "button", className: cssClasses.clearButton, title: this.question.clearButtonCaption, onClick: function () { return _this.question.clearValueFromUI(); } },
    ...
    var SurveyQuestionButtonGroup = /** @class */ (function (_super) {
        ...
        SurveyQuestionButtonGroup.prototype.renderItems = function () {
            ...
            return this.question.visibleChoices.map(function (item, index) {
                return (_$1(SurveyButtonGroupItem, { key: _this.question.inputId + "_" + index, item: item, question: _this.question, index: index }));
            });
        };
    ...
    var SurveyButtonGroupItem = /** @class */ (function (_super) {
        ...
        SurveyButtonGroupItem.prototype.renderInput = function () {
            var _this = this;
            return (_$1("input", { className: this.model.css.control, id: this.model.id, type: "radio", name: this.model.name, checked: this.model.selected, value: this.model.value, disabled: this.model.readOnly, onChange: function () {
    ...
    var SliderLabelItem = /** @class */ (function (_super) {
        ...
        SliderLabelItem.prototype.renderElement = function () {
            ...
            return _$1("div", { key: this.item.uniqueId, className: getLabelCss(locText), style: { left: getPercent(value) + "%" }, onPointerUp: function (e) { handleLabelPointerUp(e.nativeEvent, value); } },
    ...
    var Header = /** @class */ (function (_super) {
        ...
        Header.prototype.renderElement = function () {
            ...
            if (this.props.survey.isMobile) {
                ...
                headerContent = (_$1("div", { className: this.model.contentClasses, style: { maxWidth: this.model.maxWidth } }, this.model.cells.map(function (cell, index) { return _$1(HeaderCell, { key: index, model: cell }); })));
            }
    ...
    function renderSurvey(model, element, props) {
        ...
        var survey = _$1(Survey, __assign({ model: model }, props));
        nn(survey, element);
    }
    function renderPopupSurvey(model, element, props) {
        if (props === void 0) { props = {}; }
        var survey = _$1(PopupSurvey, __assign({ model: model }, props));
        nn(survey, element);
    }
    ...
    surveyCore.SurveyModel.platform = "js-ui";
    surveyCore.SurveyModel.prototype["render"] = function (element) {
    ...
    var preact = React;
    surveyCore.checkLibraryVersion("".concat("2.5.33"), "survey-js-ui");
    ...
    exports.cloneElement = _n;
    exports.createContext = Q$1;
    exports.createElement = _$1;
    exports.createFactory = dn;
    exports.createPortal = $;
    exports.createRef = b$1;
    exports.findDOMNode = Sn;
    exports.flushSync = En;
    exports.forwardRef = D;
    exports.hydrate = tn;
    exports.isFragment = pn;
    exports.isMemo = yn;
    exports.isValidElement = mn;
    exports.lazy = z;
    exports.memo = M;
    exports.preact = preact;
    exports.render = nn;
    exports.renderPopupSurvey = renderPopupSurvey;
    exports.renderSurvey = renderSurvey;
    exports.startTransition = R;
    exports.unmountComponentAtNode = bn;
    exports.unstable_batchedUpdates = gn;
    exports.useCallback = q$1;
    exports.useContext = x$1;
    exports.useDebugValue = P$1;
    exports.useDeferredValue = w;
    exports.useEffect = y;
    exports.useId = g$1;
    exports.useImperativeHandle = F$1;
    exports.useInsertionEffect = I;
    exports.useLayoutEffect = _;
    exports.useMemo = T$1;
    exports.useReducer = h;
    exports.useRef = A$1;
    exports.useState = d;
    exports.useSyncExternalStore = C;
    exports.useTransition = k;
    exports.version = vn;
